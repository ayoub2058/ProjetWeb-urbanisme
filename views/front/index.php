        ...
        <header class="header">
            ...
            <div class="auth-buttons">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <a href="../../admin/user/user-dashboard.php" class="btn btn-primary">Account</a>
                <?php else: ?>
        ...
        <section class="services-section">
            ...
            <div class="services-grid">
                <div class="service-card" data-tilt data-tilt-scale="1.05">
                    ...
                    <a href="carpooling.php" class="btn btn-small">Explore</a>
                </div>
                ...
                <div class="service-card" data-tilt data-tilt-scale="1.05">
                    ...
                    <a href="home-rent.php" class="btn btn-small">Explore</a>
                </div>
                ...
                <div class="service-card" data-tilt data-tilt-scale="1.05">
                    ...
                    <a href="car-rent.php" class="btn btn-small">Explore</a>
                </div>
                ...
                <div class="service-card" data-tilt data-tilt-scale="1.05">
                    ...
                    <p>Send or receive packages quickly and securely with our trusted delivery service.</p>
                    <a href="deliver-package.html" class="btn btn-small">Explore</a>
                </div>
            </div>
        </section>
